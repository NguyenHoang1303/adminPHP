                    ...
                    <div class="col-md-9 col-sm-9 ">
                        <form>
                            ...
                            <div class="form-group item">
                                <label for="middle-name" class="col-form-label col-md-3 col-sm-3 label-align">Checkboxes
                                    and
                                    radios</label>
                                <div class="col-md-8 col-sm-8 ">
                                    <div class="checkbox">
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-8 col-sm-8 col-form-label">
                                    <div class="checkbox ">
                                        <label>
                                            Male:<input type="radio" class="flat" name="gender" id="genderM" value="M"
                                                        checked=""
                                                        required/>
                                        </label>
                                        <label>
                                            Female:<input type="radio" class="flat" name="gender" id="genderF"
                                                          value="F"/>
                                        </label>
                                        <label>
                                            Other:<input type="radio" class="flat" name="gender" id="genderO"
                                                         value="O"/>
                                        </label>
                                    </div>
                                </div>
                            ...
                            <div class="item form-group">
                                <label class="col-form-label col-md-3 col-sm-3 label-align">Introduce yourself</label>
                                <div class="col-md-8 col-sm-8">
                                    <div class="x_content">
                                        <div id="alerts"></div>
