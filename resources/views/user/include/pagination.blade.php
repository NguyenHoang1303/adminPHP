@if($paginator->hasPages())
    ...
    @if($paginator->onFirstPage())
        <a class="disabled flex-c-m txt-s-115 cl6 size-a-24 how-btn1 bo-all-1 bocl15 hov-btn1 trans-04 m-all-3 p-b-1">
            Previous
    ...
    @else
        <a href="{{ $paginator->previousPageUrl() }}"
           class="disabled flex-c-m txt-s-115 cl6 size-a-24 how-btn1 bo-all-1 bocl15 hov-btn1 trans-04 m-all-3 p-b-1">
            Previous
            <span class="lnr lnr-chevron-right m-t-3 m-l-7"></span>
            <span class="lnr lnr-chevron-right m-t-3"></span>
        </a>
