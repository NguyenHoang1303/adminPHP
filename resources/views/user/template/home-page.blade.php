...
@section('content')
            ...
            <div id="rev_slider_6" class="rev_slide fullwidthabanner" data-version="5.4.5" style="display:none">
                <ul>
                    ...
                    <li data-transition="fade">
                        <!--  -->
                        <img src="/user/images/bg-slide-10.jpg" alt="IMG-BG" class="rev-slidebg">
                        ...
                        <div class="tp-caption tp-resizeme flex-c-m flex-w layer1" data-frames='[{"delay":1700,"speed":1500,"frame":"0","from":"y:-150px;opacity:0;","to":"o:1;","ease":"Power3.easeInOut"},{"delay":"wait","speed":300,"frame":"999","to":"auto:auto;","ease":"Power3.easeInOut"}]'
                            ...
                            <img src="/user/images/icons/symbol-42.png" alt="IMG">
                        </div>
                        ...
                        <div class="tp-caption tp-resizeme flex-c-m flex-w layer3" data-frames='[{"delay":2500,"speed":1500,"frame":"0","from":"y:150px;opacity:0;","to":"o:1;","ease":"Power3.easeInOut"},{"delay":"wait","speed":300,"frame":"999","to":"opacity:0;","ease":"Power3.easeInOut"}]'
                             ...
                             data-paddingbottom="[0, 0, 0, 0]" data-paddingleft="[15, 15, 15, 15]" data-basealign="slide" data-responsive_offset="on">
                            <img src="/user/images/icons/symbol-19.png" alt="IMG">
                        </div>
                    </li>
                    ...
                    <li data-transition="fade">
                        <!--  -->
                        <img src="/user/images/bg-slide-12.jpg" alt="IMG-BG" class="rev-slidebg">
                    ...
                    <li data-transition="fade">
                        <!--  -->
                        <img src="/user/images/bg-slide-11.jpg" alt="IMG-BG" class="rev-slidebg">
    ...
    <section class="sec-about bg0 p-t-120 flex-w flex-str">
        <div class="size-w-46 p-rl-15 p-t-72 order-lg-2 respon13">
            <div class="size-a-1 flex-col-l p-b-25">
                <div class="txt-m-201 cl10 how-pos1-parent m-b-14">
                    ...
                    <div class="how-pos1">
                        <img src="/user/images/icons/symbol-02.png" alt="IMG">
                    </div>
                </div>
            ...
            <div class="flex-w flex-sb p-t-55">
                <div class="flex-col-c-m size-w-47 how-shadow3 p-rl-12 p-t-45 p-b-40 m-b-23 respon14">
                    <img src="/user/images/icons/symbol-37-min.png" alt="SYMBOL">
                ...
                <div class="flex-col-c-m size-w-47 how-shadow3 p-rl-12 p-t-45 p-b-40 m-b-23 respon14">
                    <img src="/user/images/icons/symbol-38-min.png" alt="SYMBOL">
                    <span class="txt-s-117 cl10 txt-center p-t-22">
						Do jobs only
					</span>
                </div>
                ...
                <div class="flex-col-c-m size-w-47 how-shadow3 p-rl-12 p-t-45 p-b-40 m-b-23 respon14">
                    <img src="/user/images/icons/symbol-39-min.png" alt="SYMBOL">
                    <span class="txt-s-117 cl10 txt-center p-t-22">
						Fresh produce
					</span>
                </div>
                ...
                <div class="flex-col-c-m size-w-47 how-shadow3 p-rl-12 p-t-45 p-b-40 m-b-23 respon14">
                    <img src="/user/images/icons/symbol-40-min.png" alt="SYMBOL">
                    <span class="txt-s-117 cl10 txt-center p-t-22">
						Best equipment
					</span>
                </div>
                ...
                <div class="flex-col-c-m size-w-47 how-shadow3 p-rl-12 p-t-45 p-b-40 m-b-23 respon14">
                    <img src="/user/images/icons/symbol-41-min.png" alt="SYMBOL">
                    <span class="txt-s-117 cl10 txt-center p-t-22">
						Organic nature
					</span>
                </div>
                ...
                <div class="flex-col-c-m size-w-47 how-shadow3 p-rl-12 p-t-45 p-b-40 m-b-23 respon14">
                    <img src="/user/images/icons/symbol-43.png" alt="SYMBOL">
                    <span class="txt-s-117 cl10 txt-center p-t-22">
						Early delivery
					</span>
                </div>
        ...
        <div class="size-w-45 flex-b p-rl-40 p-t-30 order-lg-1 w-full-lg p-rl-15-sm">
            <div class="wrap-pic-max-w">
                <img src="/user/images/other-11.jpg" alt="IMG">
            </div>
        </div>
    </section>
            ...
            <div class="row gallery-lb">
                <div class="col-sm-10 col-md-6 col-lg-4 p-b-30 m-rl-auto">
                    <div class="gallery-item wrap-pic-w">
                        <img src="/user/images/gallery-01.jpg" alt="GALLERY">

                        <div class="gallery-overlay flex-c-m trans-04">
                            <div class="gallery-content flex-w flex-c-m w-full">
                                <a class="flex-c-m gallery-btn m-all-5 trans-04 js-show-gallery" href="/user/images/gallery-01.jpg">
                                    <img src="/user/images/icons/icon-open.png" alt="OPEN">
                                </a>

                                <a href="#" class="flex-c-m gallery-btn m-all-5 trans-04">
                                    <img src="/user/images/icons/icon-link.png" alt="LINK">
                                </a>
                ...
                <div class="col-sm-10 col-md-6 col-lg-4 p-b-30 m-rl-auto">
                    <div class="gallery-item wrap-pic-w">
                        <img src="/user/images/gallery-02.jpg" alt="GALLERY">

                        <div class="gallery-overlay flex-c-m trans-04">
                            <div class="gallery-content flex-w flex-c-m w-full">
                                <a class="flex-c-m gallery-btn m-all-5 trans-04 js-show-gallery" href="/user/images/gallery-02.jpg">
                                    <img src="/user/images/icons/icon-open.png" alt="OPEN">
                                </a>
                ...
                <div class="col-sm-10 col-md-6 col-lg-4 p-b-30 m-rl-auto">
                    <div class="gallery-item wrap-pic-w">
                        <img src="/user/images/gallery-03.jpg" alt="GALLERY">

                        <div class="gallery-overlay flex-c-m trans-04">
                            <div class="gallery-content flex-w flex-c-m w-full">
                                <a class="flex-c-m gallery-btn m-all-5 trans-04 js-show-gallery" href="/user/images/gallery-03.jpg">
                                    <img src="/user/images/icons/icon-open.png" alt="OPEN">
                                </a>
                ...
                <div class="col-sm-10 col-md-6 col-lg-4 p-b-30 m-rl-auto">
                    <div class="gallery-item wrap-pic-w">
                        <img src="/user/images/gallery-04.jpg" alt="GALLERY">

                        <div class="gallery-overlay flex-c-m trans-04">
                            <div class="gallery-content flex-w flex-c-m w-full">
                                <a class="flex-c-m gallery-btn m-all-5 trans-04 js-show-gallery" href="/user/images/gallery-04.jpg">
                                    <img src="/user/images/icons/icon-open.png" alt="OPEN">
                                </a>
                ...
                <div class="col-sm-10 col-md-6 col-lg-4 p-b-30 m-rl-auto">
                    <div class="gallery-item wrap-pic-w">
                        <img src="/user/images/gallery-05.jpg" alt="GALLERY">

                        <div class="gallery-overlay flex-c-m trans-04">
                            <div class="gallery-content flex-w flex-c-m w-full">
                                <a class="flex-c-m gallery-btn m-all-5 trans-04 js-show-gallery" href="/user/images/gallery-05.jpg">
                                    <img src="/user/images/icons/icon-open.png" alt="OPEN">
                                </a>
                ...
                <div class="col-sm-10 col-md-6 col-lg-4 p-b-30 m-rl-auto">
                    <div class="gallery-item wrap-pic-w">
                        <img src="/user/images/gallery-06.jpg" alt="GALLERY">

                        <div class="gallery-overlay flex-c-m trans-04">
                            <div class="gallery-content flex-w flex-c-m w-full">
                                <a class="flex-c-m gallery-btn m-all-5 trans-04 js-show-gallery" href="/user/images/gallery-06.jpg">
                                    <img src="/user/images/icons/icon-open.png" alt="OPEN">
                                </a>
        ...
        <div class="container">
            ...
            <div class="row isotope-grid">
                ...
                <div class="col-sm-6 col-md-4 col-lg-3 p-b-75 isotope-item fruit-juic-fill other-fill">
                    ...
                    <div class="block1">
                        <div class="block1-bg wrap-pic-w bo-all-1 bocl12 hov3 trans-04">
                            <img src="/user/images/product-01.jpg" alt="IMG">
                            ...
                            <div class="block1-content flex-col-c-m p-b-46">
                                ...
                                <div class="block1-wrap-icon flex-c-m flex-w trans-05">
                                    ...
                                    <a href="wishlist.html" class="block1-icon flex-c-m wrap-pic-max-w js-addwish-b1">
                                        ...
                                        <img class="icon-addedwish-b1" src="/user/images/icons/icon-heart2.png" alt="ICON">
                                    </a>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-sm-6 col-md-4 col-lg-3 p-b-75 isotope-item fruit-fill">
                    ...
                    <div class="block1">
                        <div class="block1-bg wrap-pic-w bo-all-1 bocl12 hov3 trans-04">
                            <img src="/user/images/product-02.jpg" alt="IMG">
                ...
                <div class="col-sm-6 col-md-4 col-lg-3 p-b-75 isotope-item vegetable-fill dried-fill other-fill">
                    ...
                    <div class="block1">
                        <div class="block1-bg wrap-pic-w bo-all-1 bocl12 hov3 trans-04">
                            <img src="/user/images/product-03.jpg" alt="IMG">
                ...
                <div class="col-sm-6 col-md-4 col-lg-3 p-b-75 isotope-item vegetable-fill dried-fill">
                    ...
                    <div class="block1">
                        <div class="block1-bg wrap-pic-w bo-all-1 bocl12 hov3 trans-04">
                            <img src="/user/images/product-04.jpg" alt="IMG">
                ...
                <div class="col-sm-6 col-md-4 col-lg-3 p-b-75 isotope-item fruit-fill fruit-juic-fill other-fill">
                    ...
                    <div class="block1">
                        <div class="block1-bg wrap-pic-w bo-all-1 bocl12 hov3 trans-04">
                            <img src="/user/images/product-05.jpg" alt="IMG">
                ...
                <div class="col-sm-6 col-md-4 col-lg-3 p-b-75 isotope-item fruit-juic-fill">
                    ...
                    <div class="block1">
                        <div class="block1-bg wrap-pic-w bo-all-1 bocl12 hov3 trans-04">
                            <img src="/user/images/product-06.jpg" alt="IMG">
                ...
                <div class="col-sm-6 col-md-4 col-lg-3 p-b-75 isotope-item vegetable-fill other-fill">
                    ...
                    <div class="block1">
                        <div class="block1-bg wrap-pic-w bo-all-1 bocl12 hov3 trans-04">
                            <img src="/user/images/product-07.jpg" alt="IMG">
                ...
                <div class="col-sm-6 col-md-4 col-lg-3 p-b-75 isotope-item fruit-fill fruit-juic-fill">
                    ...
                    <div class="block1">
                        <div class="block1-bg wrap-pic-w bo-all-1 bocl12 hov3 trans-04">
                            <img src="/user/images/product-08.jpg" alt="IMG">
    ...
    <!-- Delivery -->
    <section class="sec-delivery bg-img1 p-t-145 p-b-100" style="background-image: url(/user/images/bg-02.jpg);">
        <div class="container">
            ...
            <div class="txt-center pos-relative">
                <img class="max-w-full" src="/user/images/other-12.png" alt="IMG">
            </div>
        </div>
    </section>
            ...
            <div class="row">
                <div class="col-sm-10 col-md-12 col-lg-4 p-b-20 m-rl-auto-md">
                    <div class="p-r-20 p-rl-0-xl p-b-45 p-t-5 s-full">
                        <div class="s-full bg-img1 flex-col-c p-t-60 p-b-300 p-rl-15" style="background-image: url(/user/images/bg-06.jpg);">
                            ...
                            <ul class="p-t-67">
                                <li class="flex-w flex-t p-b-40">
                                    <div class="size-w-48 wrap-pic-max-w txt-left">
                                        <img src="/user/images/icons/symbol-48.png" alt="SYMBOL">
                                    </div>
                                ...
                                <li class="flex-w flex-t p-b-40">
                                    <div class="size-w-48 wrap-pic-max-w txt-left">
                                        <img src="/user/images/icons/symbol-49.png" alt="SYMBOL">
                                    </div>
                                ...
                                <li class="flex-w flex-t p-b-40">
                                    <div class="size-w-48 wrap-pic-max-w txt-left">
                                        <img src="/user/images/icons/symbol-50.png" alt="SYMBOL">
                                    </div>
                                ...
                                <li class="flex-w flex-t p-b-40">
                                    <div class="size-w-48 wrap-pic-max-w txt-left">
                                        <img src="/user/images/icons/symbol-51.png" alt="SYMBOL">
                                    </div>
                ...
                <div class="col-sm-10 order-md-1 col-md-6 m-rl-auto">
                    <div class="flex-m h-full p-r-30 p-rl-0-lg">
                        <div class="wrap-pic-max-s">
                            <img src="/user/images/other-13.jpg" alt="IMG">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-6 col-md-4 p-b-30">
                    <div>
                        <a href="blog-single.html" class="wrap-pic-w hov4">
                            <img src="/user/images/blog-11.jpg" alt="BLOG">
                        </a>
                ...
                <div class="col-sm-6 col-md-4 p-b-30">
                    <div>
                        <a href="blog-single.html" class="wrap-pic-w hov4">
                            <img src="/user/images/blog-12.jpg" alt="BLOG">
                        </a>
                ...
                <div class="col-sm-6 col-md-4 p-b-30">
                    <div>
                        <a href="blog-single.html" class="wrap-pic-w hov4">
                            <img src="/user/images/blog-13.jpg" alt="BLOG">
                        </a>
...
@endsection
@section('page-script')
    <script src="/user/vendor/revolution/js/jquery.themepunch.tools.min.js"></script>
    <script src="/user/vendor/revolution/js/jquery.themepunch.revolution.min.js"></script>
    <script src="/user/vendor/revolution/js/extensions/revolution.extension.video.min.js"></script>
    <script src="/user/vendor/revolution/js/extensions/revolution.extension.carousel.min.js"></script>
    <script src="/user/vendor/revolution/js/extensions/revolution.extension.slideanims.min.js"></script>
    <script src="/user/vendor/revolution/js/extensions/revolution.extension.actions.min.js"></script>
    <script src="/user/vendor/revolution/js/extensions/revolution.extension.layeranimation.min.js"></script>
    <script src="/user/vendor/revolution/js/extensions/revolution.extension.kenburn.min.js"></script>
    <script src="/user/vendor/revolution/js/extensions/revolution.extension.navigation.min.js"></script>
    <script src="/user/vendor/revolution/js/extensions/revolution.extension.migration.min.js"></script>
    <script src="/user/vendor/revolution/js/extensions/revolution.extension.parallax.min.js"></script>
    <script src="/user/js/revo-custom.js"></script>
    <!--===============================================================================================-->
