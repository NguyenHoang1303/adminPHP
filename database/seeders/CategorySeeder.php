...
//            ->create();
        DB::table('categories')->insert([
            [
                'id' => 1,
                'name' => 'Thực phẩm khô',
                'thumbnail' => 'https://res.cloudinary.com/nguyenhs/image/upload/v1634309336/Demo_Laravel/Dried_vavewm.jpg',
            ...
            [
                'id' => 2,
                'name' => 'Rau củ',
                'thumbnail' => 'https://res.cloudinary.com/nguyenhs/image/upload/v1634309336/Demo_Laravel/vegetables_nkjbll.jpg',
            ...
            [
                ...
                'thumbnail' => 'https://res.cloudinary.com/nguyenhs/image/upload/v1634309329/Demo_Laravel/HOW-fruit-juice_skmhl4.jpg',
            ...
            [
                'id' => 4,
                'name' => 'Hoa quả',
                'thumbnail' => 'https://res.cloudinary.com/nguyenhs/image/upload/v1634309336/Demo_Laravel/fruits_knepmg.jpg',
